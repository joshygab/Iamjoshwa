...
export interface EventItem{id:string;slug:string;universe:Universe;name:string;date:string;doors:string;setTime:string;venue:string;address:string;city:string;country:string;lineup:string[];genres:string[];age:string;priceLabel:string;ticketMode?:EventTicketMode;ticketUrl?:string;registrationUrl?:string;mapUrl?:string;description:string;status:EventStatus;featured?:boolean;demo:boolean;flyerUrl?:string;promoCode?:string;faq?:{question:string;answer:string}[];afterContent?:{title:string;body:string;setUrl?:string}}
